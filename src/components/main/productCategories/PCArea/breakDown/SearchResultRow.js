...
import { removePC } from '../../../../../actions/PC-actions';
...
class SearchResultRow extends Component {
    ...
    updatedb = (name) => {
        let productCategory = { id: this.state.editId, name: name }
    ...
    deleteRow(e) {
        ...
        document.getElementById('PCtbl').deleteRow(i)
        ...
        fetch('/deletePC', options)
            .then((res) => res.json())
            .then((json) => {
                console.log(json)
                this.props.dispatch(removePC(json.data));
