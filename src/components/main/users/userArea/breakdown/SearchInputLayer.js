        ...
        return (
            ...
            <div className='row col-12 m-0 justify-content-center'>
                ...
                <div className='col-md-2.5 mb-2  '>
                    <select value={searchFilter} onChange={this.handleSearchFilterChange} className='Uselect'>
                ...
                <div className='col-md-2.5 mb-2  '>
                    <div className="input-group">
                        <input value={searchText} onChange={this.handleSearchTextChange} type="text" className="Usearch-input" ref='search' placeholder="Search Users.." />
                        <div className="input-group-append">
                            <button style={{ border: '2px solid #783f04', borderLeft: 'none', background: '#ddd' }} className="btn " type="button" disabled>
                                <FontAwesomeIcon className='Usearch-button' icon={faSearch} />
                            </button>
                        </div>
                    </div>
                </div>
                {/* <div style={{ display: 'none' }} className='col-md-2.5 mb-2  '>
                    <select value={searchLimit} onChange={this.handleSearchLimitChange} className='Uselect'>
