        ...
        return (
            ...
            <div className='row col-12 m-0 justify-content-center'>
                ...
                <div className='col-md-2.5 mb-2  '>
                    <select value={searchFilter} onChange={this.handleSearchFilterChange} className='RPselect'>
                        <option value="role">Search By Role</option>
                        <option value="permission">Search By Permission</option>
                    </select>
                </div>
                <div className='col-md-2.5 mb-2  '>
                    <div className="input-group">
                        <input value={searchText} onChange={this.handleSearchTextChange} type="text" className="RPsearch-input" ref='search' placeholder="Search Roles' Permissions.." />
